                                        ...
                                        "<div class='row'>"+
                                            "<div class='col-md-4 col-sm-12'>"+
                                                "<video class='embed-responsive embed-responsive-16by9'>"+
                                                    "<source src=../"+json.my_courses[course].url_video+" type='video/mp4'>"+
                                                "</video>"+
                                            "</div>"+
                                            "<div class='col-md-8 col-sm-12'>"+
                                                "<p>"+json.my_courses[course].description+"</p>"+
                                                "<h5>"+json.my_courses[course].title+"</h5>"+
                                                "<a href='start-course?value="+json.my_courses[course].id_course+
                                                "&title="+json.my_courses[course].title+"&descri="+json.my_courses[course].description+
